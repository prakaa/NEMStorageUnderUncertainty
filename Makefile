...
PROJECT_NAME = NEMStorageUnderUncertainty
...
install_get_NEM_data:
	...
	. data_scripts/NEMSUU_venv/bin/activate; pip install -e data_scripts/.
...
## Compile summary and VPL/VPI results from simulation raw data
compile_results:
